...
public class UserDAOImpl implements UserDAO {
	...
	public boolean isEmailUnique(String email) {
		...
		if (user == null)
			...
			return false;// entered email is duplicate,another user has already registered with same
							// email id
	}
	...
	public User login(User user) {
		...
		return (User) sessionFactory.getCurrentSession()
				...
				.uniqueResult();
		/*
		 * query.setString(0, user.getEmail()); query.setString(1, user.getPassword());
